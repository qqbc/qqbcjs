...
import { Api } from '../qqbcjs-api';
import { JsonRpc } from '../qqbcjs-jsonrpc';
import { JsSignatureProvider } from '../qqbcjs-jssig';

const transaction = {
    expiration: '2020-06-04T18:42:49',
    ref_block_num: 38096,
...
const deserializedTx = {
    ...
    context_free_actions: [] as any,
    delay_sec: 0,
    expiration: '2020-06-04T18:42:49.000',
    max_cpu_usage_ms: 0,
    max_net_usage_words: 0,
    ref_block_num: 4946161,
    ref_block_prefix: 505360011,
    transaction_extensions: [] as any,
};
...
describe('qqbcjs-api', () => {
    ...
    beforeEach(() => {
        ...
        const signatureProvider = new JsSignatureProvider(['5K7fZxoHUhb4Jx9AQgTAPpLMF5yykm8vyfnp5a62mz1dGcABhPY']);
        const chainId = '97d0d09f493882b36e65ecbfbee712df473b6e2d3d920a75abb8517acd4c138e';
        api = new Api({
    ...
    it('getAbi returns an abi', async () => {
        const response = await api.getAbi('qqbctest1112');
    ...
    it('getContract returns a contract', async () => {
        const response = await api.getContract('qqbctest1112');
    ...
    it('deserializeTransaction converts tx from binary', () => {
        ...
        // const tx = api.serializeTransaction(deserializedTx);
        // console.log(tx);
