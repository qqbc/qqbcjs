...
import * as ecc from 'qqbcjs-ecc';
import { SignatureProvider, SignatureProviderArgs } from './qqbcjs-api-interfaces';
import { convertLegacyPublicKey } from './qqbcjs-numeric';
